...
export default class SoundManager {
   ...
   * 
   */
  public static prepareSound(soundName: string): void {
    ...
    SoundManager.instance.soundBuffers[soundName] = resources[soundName].buffer;
  }
  /**
   * 効果音を再生する
   */
  public static playSound(soundName: string, volume: number): void {
